package com.yushi.code.tableCreator.factory;

import com.alibaba.druid.pool.DruidDataSourceFactory;
import com.yushi.code.tableCreator.autoconfig.AutoConfigConfiguration;
import com.yushi.code.tableCreator.exception.DataSourceException;
...
import static com.yushi.code.tableCreator.autoconfig.AutoConfigConfiguration.DataSourceConfig.DataSourceType.*;
...
public class DataSourceConfigurationFactory {
  @Nonnull
  public static DataSource getDataSource(final AutoConfigConfiguration.DataSourceConfig config) {
    ...
    final AutoConfigConfiguration.DataSourceConfig.DataSourceType type = getDataSourceType(firstKey);
  ...
  private static AutoConfigConfiguration.DataSourceConfig.DataSourceType getDataSourceType(final String key) {
