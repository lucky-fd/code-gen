package com.yushi.code.east.factory;

import com.alibaba.druid.pool.DruidDataSourceFactory;
import com.yushi.code.east.autoconfig.AutoConfiguration;
import com.yushi.code.east.exception.DataSourceException;
...
import static com.yushi.code.east.autoconfig.AutoConfiguration.DataSourceConfig.DataSourceType.*;
...
public class DataSourceConfigurationFactory {
  @Nonnull
  public static DataSource getDataSource(final AutoConfiguration.DataSourceConfig config) {
    ...
    final AutoConfiguration.DataSourceConfig.DataSourceType type = getDataSourceType(firstKey);
  ...
  private static AutoConfiguration.DataSourceConfig.DataSourceType getDataSourceType(final String key) {
