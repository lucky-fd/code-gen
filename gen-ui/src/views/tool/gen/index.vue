<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" height="700">
...
import GenEdit from "@/views/tool/gen/editTable";
...
export default {
    name: "Gen",
    components: {GenEdit, importTable},
    data() {
        return {
            // 遮罩层
            loading: true,
    ...
    methods: {
        ...
        handleGenTable(row) {
            ...
            if (row.genType === "1") {
                ...
                this.$download.zip("/gen/batchGenCode?tables=" + tableNames, "generateCode");
            }
        },
        /** 同步数据库操作 */
        handleSynchDb(row) {
